...
def calculate_express(snplst, pop, request, web, r2_d, r2_d_threshold=0.1, window=500000):
...
def main():
    ...
    # Run function
    (sanitized_query_snps, thinned_list, details) = calculate_express(snplst, pop, request, web, r2_d, r2_d_threshold)
