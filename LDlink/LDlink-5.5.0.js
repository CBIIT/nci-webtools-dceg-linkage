var ldlink_version = "Version 5.5.0";
...
var ldassocData=[{RS_Number:"rs75563749",Coord:"chr3:171031233",Alleles:"(A/T)",MAF:.1983,Distance:348304,Dprime:.0512,R2:.0021,Correlated_Alleles:"= , =",FORGEdb:10,RegulomeDB:6,Functional_Class:"NA"},{RS_Number:"rs76189435",Coord:"chr3:170980080",Alleles:"(C/G)",MAF:.0527,Distance:-51153,Dprime:.622,R2:.0871,Correlated_Alleles:"= , =",FORGEdb:10,RegulomeDB:"2b",Functional_Class:"NA"},{RS_Number:"rs76140932",Coord:"chr3:170980434",Alleles:"(A/G)",MAF:.0539,Distance:-50799,Dprime:.6073,R2:.085,Correlated_Alleles:"= , =",FORGEdb:10,RegulomeDB:"2b",Functional_Class:"NA"},{RS_Number:"rs76735261",Coord:"chr3:170981252",Alleles:"(G/C)",MAF:.0539,Distance:-49981,Dprime:.6073,R2:.085,Correlated_Alleles:"= , =",FORGEdb:8,RegulomeDB:5,Functional_Class:"NA"},{RS_Number:"rs1158564",Coord:"chr3:171002654",Alleles:"(A/G)",MAF:.4439,Distance:-28579,Dprime:.866,R2:.2324,Correlated_Alleles:"A=A,G=T",FORGEdb:7,RegulomeDB:"2b",Functional_Class:"NA"},{RS_Number:"rs4894756",Coord:"chr3:171002036",Alleles:"(G/A)",MAF:.3806,Distance:-29197,Dprime:.8732,R2:.3069,Correlated_Alleles:"G=A,A=T",FORGEdb:7,RegulomeDB:4,Functional_Class:"NA"},{RS_Number:"rs200296423",Coord:"chr3:170969849",Alleles:"(TGCG/-)",MAF:.0475,Distance:-61384,Dprime:.5965,R2:.0718,Correlated_Alleles:"= , =",FORGEdb:"",RegulomeDB:".",Functional_Class:"NA"},{RS_Number:"rs377580557",Coord:"chr3:171001114",Alleles:"(TTTTCTC/-)",MAF:.0445,Distance:-30119,Dprime:.67,R2:.0846,Correlated_Alleles:"= , =",FORGEdb:"",RegulomeDB:".",Functional_Class:"NA"},{RS_Number:"rs377580557",Coord:"chr3:171001114",Alleles:"(TTTTCTC/-)",MAF:.0445,Distance:-30119,Dprime:.67,R2:.0846,Correlated_Alleles:"= , =",FORGEdb:"",RegulomeDB:".",Functional_Class:"NA"},{RS_Number:"rs6444976",Coord:"chr3:171002143",Alleles:"(G/C)",MAF:.3808,Distance:-29090,Dprime:.8731,R2:.3066,Correlated_Alleles:"G=A,C=T",FORGEdb:6,RegulomeDB:4,Functional_Class:"NA"},{RS_Number:"rs13090306",Coord:"chr3:170969666",Alleles:"(A/C)",MAF:.4163,Distance:-61567,Dprime:.5359,R2:.0996,Correlated_Alleles:"= , =",FORGEdb:9,RegulomeDB:5,Functional_Class:"NA"}];
...
$(document).ready(function() {
    ...
    $.get("news-5.5.0.html", function (data) {
    ...
    var new_assoc_data = {
        "aaData": [
            ["rs75563749","chr7","24958977","(C/T)","0.2037",-726,"0.234","0.234","C-C","0.0", "10","7","HaploReg link","NA"],
...
function setupLDexpressControls() {
    ...
    toggleShowThinnedLists('toggle-show-ldexpress-thin-snps', 'ldexpress-snp-list');
    toggleShowThinnedLists('toggle-show-ldexpress-thin-genes', 'ldexpress-genes-list');
    toggleShowThinnedLists('toggle-show-ldexpress-thin-tissues', 'ldexpress-tissues-list');
...
function populateAssocDropDown(headers) {
    $.each(dropdowns, function(i, id) {
        ...
        $.each(headers, function(key, value){
            $("#"+id).find("ul").append('<li role="presentation"><a role="menuitem" tabindex="-1">'+value+'</a></li>');
        });
...
function updateLDassoc() {
    ...
    var r2url = 'http://genome.ucsc.edu/cgi-bin/hgTracks?db=' + tempbuild  + '&hgt.customText=http://'+location.hostname+'/tmp/track' + ldInputs.reference + '.txt'
    //console.log(r2url)
...
function updateLDproxy() {
    ...
    $('#ldproxy-genome').attr('href',
        'http://genome.ucsc.edu/cgi-bin/hgTracks?db=' + proxy_build + '&hgt.customText=http://'+location.hostname+'/tmp/track'
