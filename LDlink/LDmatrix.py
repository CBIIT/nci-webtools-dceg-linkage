...
def calculate_matrix(snplst, pop, request, r2_d="r2"):
    ...
    # OLD BOKEH VERSION FIX GLYPHS - END
    # NEW BOKEH VERSION FIX GLYPHS - START
    matrix_plot.rect(x='xname_pos', y='yname', width=0.70710678118, height=0.70710678118, angle=0.785398, source=source,
                    color="box_color", alpha="box_trans", line_color=None)
    # matrix_plot.square(x='xname_pos', y='yname', size=24, angle=0.785398, source=source,
    #                 color="box_color", alpha="box_trans", line_color=None) 
    # matrix_plot.square(x='xname_pos', y='yname', size=24, source=source,
    #                 color="box_color", alpha="box_trans", line_color=None) 
    # NEW BOKEH VERSION FIX GLYPHS - END
