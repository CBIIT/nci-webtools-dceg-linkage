...
def get_query_variant_c(snp_coord, pop_ids, request, genome_build, is_output,output={}):
    ...
    if "," in geno[3] or "," in geno[4]:
        ...
        output["error"] = snp_coord[0]+ " is not a biallelic." + str(output["error"] if "error" in output else "")
    ...
    if genotypes["0"] == 0 or genotypes["1"] == 0:
        ...
        output["error"] = snp_coord[0]+ " is monoallelic in the chosen population(s)." + str(output["error"] if "error" in output else "")
