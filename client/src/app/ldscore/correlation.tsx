            ...
            <Form.Group controlId="ldscoreSource" className="mb-3">
              ...
              {ldscoreSourceValue.mode === "customImport" && (
                <div className="mt-2">
                  ...
                  />
                  <div style={{ fontSize: "0.85rem" }}>Upload matching *.l2.ldscore.gz, *.l2.M, *.l2.M_5_50 files (same base name). The base name must contain exactly one chromosome number (1-22, or chrN) -- remove any duplicate-download suffix like " (1)" before uploading.</div>
