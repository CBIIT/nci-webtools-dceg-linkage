      ...
      <Container fluid="md">
        ...
        <CitationBox />
          <div style={{ wordBreak: 'normal', overflowWrap: 'break-word', marginTop: '1rem' }}>
            Breeze C.E., Yao, X., Park, B., Kanigicherla, M., Lan, Q., Rothman, N., Teschendorff, A.E., Franceschini, N., Berndt, S.I., and Machiela, M.J. (2025). <a href="https://doi.org/10.64898/2025.12.19.695639" target="_blank" style={{ whiteSpace: 'nowrap' }}>LDscore: a scalable, Python 3-powered web platform for LD score regression analysis.</a> <i>bioRxiv</i>. 2025 Dec 19.
          </div>
        </Row>
      </Container>
    </>
