...
const modules = [
  ...
  },
  {
    ...
    input: [
      ...
      '<u>For heritability analysis</u> GWAS summary statistics from PLINK, REGENIE, SAIGE, or LDSC-ready/pre-munged files. Uploaded producer files are detected from their headers and normalized to LDSC-ready columns before being processed by <a href="https://github.com/bulik/ldsc/blob/master/munge_sumstats.py" target="_blank">munge_sumstats.py</a>. Supported content should include SNP identifiers, alleles, sample size, p-value, and a signed effect such as BETA or OR. REGENIE LOG10P values are converted to P automatically. In addition, a reference population needs to be selected from the drop down menu.',
      '<u>For genetic correlation</u> - GWAS summary statistics from PLINK, REGENIE, SAIGE, or LDSC-ready/pre-munged files for both traits. Uploaded producer files are detected from their headers and normalized to LDSC-ready columns before being processed by <a href="https://github.com/bulik/ldsc/blob/master/munge_sumstats.py" target="_blank">munge_sumstats.py</a>. Supported content should include SNP identifiers, alleles, sample size, p-value, and a signed effect such as BETA or OR. REGENIE LOG10P values are converted to P automatically. In addition, a reference population needs to be selected from the drop down menu.',
